...
public class Result : IResult
{
    ...
    public Result AddFormatter(Action<ActionContext> formatter)
    {
    ...
    public static Result Continue() =>
        new(StatusCodes.Status100Continue);
    ...
    public static Result Created(string location) =>
        new Result(StatusCodes.Status201Created)
            .AddFormatter(context => context.HttpContext.Response.Headers.Location = location);
    ...
    public static Result MultipleChoices(Uri? location) =>
        new Result(StatusCodes.Status300MultipleChoices)
            .AddFormatter(context => context.HttpContext.Response.Headers.Location = location?.ToString());
    ...
    public static Result NotModified() =>
        new(StatusCodes.Status304NotModified);
    ...
    public static Result Unauthorized(StringValues wwwAuthenticate) =>
        new Result(StatusCodes.Status401Unauthorized)
            .AddFormatter(context => context.HttpContext.Response.Headers.WWWAuthenticate = wwwAuthenticate);
    ...
    public static Result MethodNotAllowed() =>
        new(StatusCodes.Status405MethodNotAllowed);

    // 406 Not Acceptable

    public static Result NotAcceptable() =>
        new(StatusCodes.Status406NotAcceptable);
    ...
    public static Result ProxyAuthenticationRequired(StringValues proxyAuthenticate) =>
        new Result(StatusCodes.Status407ProxyAuthenticationRequired)
            .AddFormatter(context => context.HttpContext.Response.Headers.ProxyAuthenticate = proxyAuthenticate);
    ...
    public static Result Gone() =>
        new(StatusCodes.Status410Gone);

    // 411 Length Required

    public static Result LengthRequired() =>
        new(StatusCodes.Status411LengthRequired);
    ...
    public static Result PayloadTooLarge() =>
        new(StatusCodes.Status413PayloadTooLarge);

    // 414 URI Too Large

    public static Result UriTooLong() =>
        new(StatusCodes.Status414UriTooLong);

    // 415 Unsupported Media Type

    public static Result UnsupportedMediaType() =>
        new(StatusCodes.Status415UnsupportedMediaType);
    ...
    public static Result RangeNotSatisfiable(StringValues contentRange) =>
        new Result(StatusCodes.Status416RangeNotSatisfiable)
            .AddFormatter(context => context.HttpContext.Response.Headers.ContentRange = contentRange);

    // 417 Expectation Failed

    public static Result ExpectationFailed() =>
        new(StatusCodes.Status417ExpectationFailed);

    // 418 I'm a Teapot

    public static Result ImATeapot() =>
        new(StatusCodes.Status418ImATeapot);

    // 428 Precondition Required

    public static Result PreconditionRequired() =>
        new(StatusCodes.Status428PreconditionRequired);

    // 431 Request Header Fields Too Large

    public static Result RequestHeaderFieldsTooLarge() =>
        new(StatusCodes.Status431RequestHeaderFieldsTooLarge);

    // 451 Unavailable for Legal Reasons

    public static Result UnavailableForLegalReasons() =>
        new(StatusCodes.Status451UnavailableForLegalReasons);
    ...
    public static Result GatewayTimeout() =>
        new(StatusCodes.Status504GatewayTimeout);

    // 505 HTTP Version Not Supported

    public static Result HttpVersionNotSupported() =>
        new(StatusCodes.Status505HttpVersionNotsupported);

    // 506 Variant Also Negotiates

    public static Result VariantAlsoNegotiates() =>
        new(StatusCodes.Status506VariantAlsoNegotiates);

    // 510 Not Extended

    public static Result NotExtended() =>
        new(StatusCodes.Status510NotExtended);

    // 511 Network Authentication Required

    public static Result NetworkAuthenticationRequired() =>
        new(StatusCodes.Status511NetworkAuthenticationRequired);
